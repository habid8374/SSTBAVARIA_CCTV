...
urlpatterns = [
    ...
    path("trabajadores/plantilla-excel/", views.trabajadores_plantilla_excel, name="trabajadores_plantilla_excel"),
    path("trabajadores/importar-excel/", views.trabajadores_importar_excel, name="trabajadores_importar_excel"),
