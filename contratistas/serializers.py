...
class TrabajadorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "fecha_revision_validacion",
            "tipo_validacion",
            "numero_pedido_cm",
            "casco_rojo",
            "clase_riesgo",
            "area_trabajo",
            "formato_inclusion_firmado",
            "registros_epp_entregados",
            "pago_seguridad_cumple",
            "induccion_empleador_registrada",
            "responsable_sst_planta_nombre",
            "responsable_sst_planta_telefono",
            "radicacion_ok",
            "radicado_por",
            "validador",
            "requisitos_ok_verificados",
